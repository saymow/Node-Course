...
exports.sendFarewellEmail = exports.sendWelcomeEmail = void 0;
var mail_1 = __importDefault(require("@sendgrid/mail"));
var sendGridApiKey = process.env.SENDGRID_API_KEY;
mail_1.default.setApiKey(sendGridApiKey);
var sendWelcomeEmail = function (_a) {
    var email = _a.email, name = _a.name;
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, mail_1.default.send({
...
var sendFarewellEmail = function (_a) {
    var email = _a.email, name = _a.name;
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
...
exports.sendFarewellEmail = sendFarewellEmail;
